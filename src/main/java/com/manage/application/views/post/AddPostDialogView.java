...
public class AddPostDialogView extends Dialog {
    ...
    public AddPostDialogView(ImageListView imageListView) {
        this.imageListView = imageListView;
        this.binder = new Binder<>(PostRequest.class);
        titleField = createTextField("Title", "");
        excerptField = createTextArea("Excerpt", "");
        contentField = createTextArea("Content", "");
